...
#include "verilated.h"
#include "verilated_vcd_c.h"  // For vcd dumping

#include "TestSimulator.h"  // For is_icarus()
#include "TestVpi.h"  // For CHECK_RESULT_NZ
#include "Vt_vpi_force_minimal.h"  // Need to include either this or VM_PREFIX_INCLUDE for VM_PREFIX to work
...
int main(int argc, char** argv) {
    ...
    constexpr int traceLevels = 99;
    topp->trace(tfp, traceLevels);
