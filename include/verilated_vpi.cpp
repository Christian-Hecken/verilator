...
auto VerilatedVpiImp::getForceControlSignals(const VerilatedVpioVarBase* const baseSignalVop) {
    VerilatedVpioVar forceEnableSignal{
        baseSignalVop->varp()->forceControlSignals()->forceEnableSignalp, baseSignalVop->scopep()};
    VerilatedVpioVar forceValueSignal{
        baseSignalVop->varp()->forceControlSignals()->forceValueSignalp, baseSignalVop->scopep()};
    return std::pair{std::make_unique<VerilatedVpioVar>(forceEnableSignal),
